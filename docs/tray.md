...
后端降级与桌面兼容性;API 用法速查见 [docs/components.md](https://gitee.com/noahliu0911/moonbit-libyue/blob/master/docs/components.md) 的
「菜单 / 托盘」一节,真实桌面实测出的坑与验证结论统一记录在
[docs/adaptation.md](https://gitee.com/noahliu0911/moonbit-libyue/blob/master/docs/adaptation.md)。
...
抓包定位过程见 [docs/adaptation.md](https://gitee.com/noahliu0911/moonbit-libyue/blob/master/docs/adaptation.md)。
...
状态标记与 [docs/adaptation.md](https://gitee.com/noahliu0911/moonbit-libyue/blob/master/docs/adaptation.md) 一致:
