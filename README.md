...
`moon run examples/showcase` — a 12-page themed demo board covering the component library and all libyue capabilities: Basic / Form / Events & Layout / Navigation / Data / Feedback + Store comparison + Native Widgets / Canvas & Rich Text + System / Window & Web / Environment, grouped in the side menu (Basic / Advanced / Reactive / Native / System), with the package version shown at the sidebar bottom (kept in sync with moon.mod); API reference in [docs/components-ui.md](https://github.com/lb091188/moonbit-libyue/blob/master/docs/components-ui.md):
