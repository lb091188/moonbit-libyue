...
- Shim/vendor changes or a re-run of `prepare.py` require forcing a relink: `moon clean`, or delete the linked executable — see [docs/relink.md](docs/relink.md) (Chinese).
